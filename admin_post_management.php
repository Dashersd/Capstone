...
<head>
    ...
    <link rel="stylesheet" href="admin_post_management.css">
...
<body>
    <div class="container-fluid">
        ...
        <div class="sidebar offcanvas-md offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel" role="navigation" aria-label="Main Sidebar">
            ...
            <nav>
                ...
                <a href="admin_post_management.php" class="active"><i class="fas fa-bullhorn"></i> POST MANAGEMENT</a>
    ...
    <script src="admin_post_management.js"></script>
