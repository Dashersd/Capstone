    ...
    <div class="container-fluid">
        ...
        <div class="sidebar offcanvas-md offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel" role="navigation" aria-label="Main Sidebar">
            ...
            <nav>
                ...
                <a href="admin_student_management.php"><i class="fas fa-user-graduate"></i><span>STUDENT MANAGEMENT</span></a>
                <a href="admin_collection.php"><i class="fas fa-money-bill-wave"></i><span>COLLECTION</span></a>
                <a href="admin_payment.php"><i class="fas fa-credit-card"></i><span>PAYMENT</span></a>
                <a href="admin_post_management.php"><i class="fas fa-bullhorn"></i><span>POST MANAGEMENT</span></a>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="admin_enrollment.php"><i class="fas fa-user-plus"></i><span>ENROLLMENT</span></a>
                        <a href="admin_trial_session.php"><i class="fas fa-users"></i><span>TRIAL SESSION</span></a>
                    </div>
                </div>
                <a href="admin_settings.php"><i class="fas fa-cogs"></i><span>ADMIN SETTINGS</span></a>
