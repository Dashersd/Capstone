...
function resetPassword(userId) {
    if (confirm('Are you sure you want to reset the password for this admin account? This will set a default password.')) {
...
function refreshAdminAccountsTable() {
    fetch('get_admin_accounts_with_passwords.php') // Updated to use the new file with passwords
        ...
        .catch(error => console.error('Error refreshing admin accounts table:', error));
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    saveBtn.addEventListener('click', function() {
        ...
        formData.append('confirm_password', document.getElementById('admin-confirm-password').value);
